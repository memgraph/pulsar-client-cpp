...
list(APPEND abseil_COMPONENT_NAMES absl::config absl::pretty_function absl::civil_time absl::time_zone absl::errno_saver absl::no_destructor absl::dynamic_annotations absl::core_headers absl::fast_type_id absl::algorithm absl::hashtable_debug_hooks absl::node_slot_policy absl::non_temporal_arm_intrinsics absl::log_internal_voidify absl::numeric_representation absl::random_seed_gen_exception absl::random_internal_traits absl::random_internal_fast_uniform_bits absl::random_internal_platform absl::has_ostream_operator absl::cordz_update_tracker absl::if_constexpr absl::atomic_hook absl::log_severity absl::strerror absl::prefetch absl::hashtable_debug absl::non_temporal_memcpy absl::leak_check absl::flags_commandlineflag_internal absl::log_internal_config absl::log_internal_nullguard absl::type_traits absl::bits absl::exponential_biased absl::random_internal_randen_slow absl::random_internal_randen_hwaes_impl absl::nullability absl::raw_logging_internal absl::base_internal absl::container_common absl::meta absl::int128 absl::periodic_sampler absl::random_internal_fastmath absl::random_internal_randen_hwaes absl::random_internal_uniform_helper absl::compare absl::spinlock_wait absl::throw_delegate absl::scoped_set_env absl::algorithm_container absl::common_policy_traits absl::debugging_internal absl::overload absl::memory absl::numeric absl::random_internal_iostream_state_saver absl::random_internal_generate_real absl::random_internal_wide_multiply absl::random_internal_randen absl::cordz_functions absl::bad_any_cast_impl absl::bad_optional_access absl::bad_variant_access absl::utility absl::base absl::cleanup_internal absl::compressed_tuple absl::container_memory absl::hash_policy_traits absl::stacktrace absl::any_invocable absl::random_internal_distribution_caller absl::random_internal_pcg_engine absl::bad_any_cast absl::span absl::optional absl::variant absl::malloc_internal absl::endian absl::cleanup absl::fixed_array absl::inlined_vector_internal absl::crc_cpu_detect absl::demangle_internal absl::debugging absl::bind_front absl::function_ref absl::log_internal_conditions absl::random_bit_gen_ref absl::random_internal_mock_helpers absl::string_view absl::any absl::inlined_vector absl::crc_internal absl::city absl::low_level_hash absl::random_internal_randen_engine absl::charset absl::strings_internal absl::graphcycles_internal absl::strings absl::layout absl::symbolize absl::flags_path_util absl::flags_commandlineflag absl::hash absl::log_internal_proto absl::log_internal_nullstream absl::log_internal_append_truncated absl::log_internal_fnmatch absl::random_distributions absl::random_internal_seed_material absl::str_format_internal absl::time absl::examine_stack absl::flags_private_handle_accessor absl::log_internal_globals absl::log_entry absl::random_internal_pool_urbg absl::random_internal_salted_seed_seq absl::str_format absl::kernel_timeout_internal absl::crc32c absl::failure_signal_handler absl::flags_marshalling absl::log_internal_format absl::log_sink absl::random_seed_sequences absl::random_internal_nonsecure_base absl::random_internal_distribution_test_util absl::synchronization absl::crc_cord_state absl::flags_program_name absl::vlog_config_internal absl::sample_recorder absl::random_random absl::cordz_statistics absl::cordz_handle absl::hashtablez_sampler absl::flags_config absl::log_globals absl::absl_vlog_is_on absl::cord_internal absl::raw_hash_set absl::flags_internal absl::log_internal_log_sink_set absl::log_initialize absl::vlog_is_on absl::cordz_info absl::raw_hash_map absl::log_sink_registry absl::cordz_sample_token absl::cordz_update_scope absl::log_internal_message absl::cord absl::btree absl::hash_function_defaults absl::log_internal_strip absl::log_internal_structured absl::status absl::flat_hash_map absl::flat_hash_set absl::node_hash_map absl::node_hash_set absl::log_internal_check_op absl::log_internal_log_impl absl::log_structured absl::statusor absl::flags_reflection absl::log_internal_check_impl absl::absl_log absl::log absl::flags absl::absl_check absl::check absl::die_if_null absl::log_streamer absl::flags_usage_internal absl::log_internal_flags absl::flags_usage absl::log_flags absl::flags_parse)
...
########### VARIABLES #######################################################################
#############################################################################################
set(abseil_PACKAGE_FOLDER_RELEASE "/home/andi.linux/.conan2/p/b/abseif3f92aec86dc9/p")
set(abseil_BUILD_MODULES_PATHS_RELEASE )


set(abseil_INCLUDE_DIRS_RELEASE )
...
set(abseil_LIBS_RELEASE absl_flags_parse absl_log_flags absl_flags_usage absl_flags_usage_internal absl_die_if_null absl_flags_reflection absl_statusor absl_log_internal_check_op absl_status absl_cord absl_log_internal_message absl_cordz_sample_token absl_cordz_info absl_log_initialize absl_log_internal_log_sink_set absl_flags_internal absl_raw_hash_set absl_cord_internal absl_log_globals absl_flags_config absl_hashtablez_sampler absl_cordz_handle absl_vlog_config_internal absl_flags_program_name absl_crc_cord_state absl_synchronization absl_random_internal_distribution_test_util absl_random_seed_sequences absl_log_sink absl_log_internal_format absl_flags_marshalling absl_failure_signal_handler absl_crc32c absl_kernel_timeout_internal absl_random_internal_pool_urbg absl_log_entry absl_log_internal_globals absl_flags_private_handle_accessor absl_examine_stack absl_time absl_str_format_internal absl_random_internal_seed_material absl_random_distributions absl_log_internal_fnmatch absl_log_internal_proto absl_hash absl_flags_commandlineflag absl_symbolize absl_strings absl_graphcycles_internal absl_strings_internal absl_low_level_hash absl_city absl_crc_internal absl_string_view absl_log_internal_conditions absl_demangle_internal absl_crc_cpu_detect absl_malloc_internal absl_stacktrace absl_base absl_bad_variant_access absl_bad_optional_access absl_bad_any_cast_impl absl_cordz_functions absl_random_internal_randen absl_debugging_internal absl_scoped_set_env absl_throw_delegate absl_spinlock_wait absl_random_internal_randen_hwaes absl_periodic_sampler absl_int128 absl_raw_logging_internal absl_random_internal_randen_hwaes_impl absl_random_internal_randen_slow absl_exponential_biased absl_log_internal_nullguard absl_flags_commandlineflag_internal absl_leak_check absl_strerror absl_log_severity absl_random_internal_platform absl_random_seed_gen_exception absl_time_zone absl_civil_time)
...
set(abseil_COMPONENTS_RELEASE absl::config absl::pretty_function absl::civil_time absl::time_zone absl::errno_saver absl::no_destructor absl::dynamic_annotations absl::core_headers absl::fast_type_id absl::algorithm absl::hashtable_debug_hooks absl::node_slot_policy absl::non_temporal_arm_intrinsics absl::log_internal_voidify absl::numeric_representation absl::random_seed_gen_exception absl::random_internal_traits absl::random_internal_fast_uniform_bits absl::random_internal_platform absl::has_ostream_operator absl::cordz_update_tracker absl::if_constexpr absl::atomic_hook absl::log_severity absl::strerror absl::prefetch absl::hashtable_debug absl::non_temporal_memcpy absl::leak_check absl::flags_commandlineflag_internal absl::log_internal_config absl::log_internal_nullguard absl::type_traits absl::bits absl::exponential_biased absl::random_internal_randen_slow absl::random_internal_randen_hwaes_impl absl::nullability absl::raw_logging_internal absl::base_internal absl::container_common absl::meta absl::int128 absl::periodic_sampler absl::random_internal_fastmath absl::random_internal_randen_hwaes absl::random_internal_uniform_helper absl::compare absl::spinlock_wait absl::throw_delegate absl::scoped_set_env absl::algorithm_container absl::common_policy_traits absl::debugging_internal absl::overload absl::memory absl::numeric absl::random_internal_iostream_state_saver absl::random_internal_generate_real absl::random_internal_wide_multiply absl::random_internal_randen absl::cordz_functions absl::bad_any_cast_impl absl::bad_optional_access absl::bad_variant_access absl::utility absl::base absl::cleanup_internal absl::compressed_tuple absl::container_memory absl::hash_policy_traits absl::stacktrace absl::any_invocable absl::random_internal_distribution_caller absl::random_internal_pcg_engine absl::bad_any_cast absl::span absl::optional absl::variant absl::malloc_internal absl::endian absl::cleanup absl::fixed_array absl::inlined_vector_internal absl::crc_cpu_detect absl::demangle_internal absl::debugging absl::bind_front absl::function_ref absl::log_internal_conditions absl::random_bit_gen_ref absl::random_internal_mock_helpers absl::string_view absl::any absl::inlined_vector absl::crc_internal absl::city absl::low_level_hash absl::random_internal_randen_engine absl::charset absl::strings_internal absl::graphcycles_internal absl::strings absl::layout absl::symbolize absl::flags_path_util absl::flags_commandlineflag absl::hash absl::log_internal_proto absl::log_internal_nullstream absl::log_internal_append_truncated absl::log_internal_fnmatch absl::random_distributions absl::random_internal_seed_material absl::str_format_internal absl::time absl::examine_stack absl::flags_private_handle_accessor absl::log_internal_globals absl::log_entry absl::random_internal_pool_urbg absl::random_internal_salted_seed_seq absl::str_format absl::kernel_timeout_internal absl::crc32c absl::failure_signal_handler absl::flags_marshalling absl::log_internal_format absl::log_sink absl::random_seed_sequences absl::random_internal_nonsecure_base absl::random_internal_distribution_test_util absl::synchronization absl::crc_cord_state absl::flags_program_name absl::vlog_config_internal absl::sample_recorder absl::random_random absl::cordz_statistics absl::cordz_handle absl::hashtablez_sampler absl::flags_config absl::log_globals absl::absl_vlog_is_on absl::cord_internal absl::raw_hash_set absl::flags_internal absl::log_internal_log_sink_set absl::log_initialize absl::vlog_is_on absl::cordz_info absl::raw_hash_map absl::log_sink_registry absl::cordz_sample_token absl::cordz_update_scope absl::log_internal_message absl::cord absl::btree absl::hash_function_defaults absl::log_internal_strip absl::log_internal_structured absl::status absl::flat_hash_map absl::flat_hash_set absl::node_hash_map absl::node_hash_set absl::log_internal_check_op absl::log_internal_log_impl absl::log_structured absl::statusor absl::flags_reflection absl::log_internal_check_impl absl::absl_log absl::log absl::flags absl::absl_check absl::check absl::die_if_null absl::log_streamer absl::flags_usage_internal absl::log_internal_flags absl::flags_usage absl::log_flags absl::flags_parse)
########### COMPONENT absl::flags_parse VARIABLES ############################################

set(abseil_absl_flags_parse_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_flags_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_usage_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_usage_DEPENDENCIES_RELEASE absl::config absl::core_headers absl::flags_usage_internal absl::raw_logging_internal absl::strings absl::synchronization)
...
set(abseil_absl_log_internal_flags_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_usage_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_streamer_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_die_if_null_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_check_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_absl_check_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_absl_log_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_check_impl_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_reflection_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_reflection_DEPENDENCIES_RELEASE absl::config absl::flags_commandlineflag absl::flags_private_handle_accessor absl::flags_config absl::strings absl::synchronization absl::flat_hash_map absl::no_destructor)
...
set(abseil_absl_statusor_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_structured_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_log_impl_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_check_op_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_node_hash_set_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_node_hash_map_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flat_hash_set_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flat_hash_map_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_status_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_status_DEPENDENCIES_RELEASE absl::atomic_hook absl::config absl::cord absl::core_headers absl::function_ref absl::inlined_vector absl::memory absl::no_destructor absl::nullability absl::optional absl::raw_logging_internal absl::span absl::stacktrace absl::strerror absl::str_format absl::strings absl::symbolize)
...
set(abseil_absl_log_internal_structured_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_strip_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_hash_function_defaults_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_btree_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cord_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_message_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cordz_update_scope_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cordz_sample_token_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_sink_registry_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_raw_hash_map_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_raw_hash_map_DEPENDENCIES_RELEASE absl::config absl::container_memory absl::core_headers absl::raw_hash_set absl::throw_delegate)
...
set(abseil_absl_cordz_info_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cordz_info_DEPENDENCIES_RELEASE absl::base absl::config absl::cord_internal absl::cordz_functions absl::cordz_handle absl::cordz_statistics absl::cordz_update_tracker absl::core_headers absl::inlined_vector absl::span absl::raw_logging_internal absl::stacktrace absl::synchronization absl::time)
...
set(abseil_absl_vlog_is_on_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_initialize_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_log_sink_set_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_raw_hash_set_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cord_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_absl_vlog_is_on_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_globals_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_config_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_hashtablez_sampler_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_hashtablez_sampler_DEPENDENCIES_RELEASE absl::base absl::config absl::exponential_biased absl::raw_logging_internal absl::sample_recorder absl::synchronization absl::time)
...
set(abseil_absl_cordz_handle_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cordz_statistics_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_random_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_sample_recorder_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_vlog_config_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_vlog_config_internal_DEPENDENCIES_RELEASE absl::base absl::config absl::core_headers absl::log_internal_fnmatch absl::memory absl::no_destructor absl::strings absl::synchronization absl::optional)
...
set(abseil_absl_flags_program_name_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_crc_cord_state_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_synchronization_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_distribution_test_util_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_nonsecure_base_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_seed_sequences_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_sink_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_format_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_marshalling_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_failure_signal_handler_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_crc32c_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_kernel_timeout_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_str_format_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_salted_seed_seq_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_pool_urbg_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_entry_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_globals_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_private_handle_accessor_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_examine_stack_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_time_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_str_format_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_str_format_internal_DEPENDENCIES_RELEASE absl::bits absl::strings absl::config absl::core_headers absl::fixed_array absl::inlined_vector absl::numeric_representation absl::type_traits absl::utility absl::int128 absl::span)
...
set(abseil_absl_random_internal_seed_material_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_distributions_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_fnmatch_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_append_truncated_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_nullstream_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_proto_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_hash_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_commandlineflag_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_path_util_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_symbolize_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_layout_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_strings_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_strings_DEPENDENCIES_RELEASE absl::string_view absl::strings_internal absl::base absl::bits absl::charset absl::config absl::core_headers absl::endian absl::int128 absl::memory absl::nullability absl::raw_logging_internal absl::throw_delegate absl::type_traits)
...
set(abseil_absl_graphcycles_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_strings_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_charset_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_charset_DEPENDENCIES_RELEASE absl::core_headers absl::string_view)
...
set(abseil_absl_random_internal_randen_engine_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_low_level_hash_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_low_level_hash_DEPENDENCIES_RELEASE absl::config absl::endian absl::int128 absl::prefetch)
...
set(abseil_absl_city_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_crc_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_inlined_vector_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_any_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_string_view_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_string_view_LIBS_RELEASE absl_string_view)
...
set(abseil_absl_string_view_DEPENDENCIES_RELEASE absl::base absl::config absl::core_headers absl::nullability absl::throw_delegate)
...
set(abseil_absl_random_internal_mock_helpers_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_bit_gen_ref_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_conditions_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_function_ref_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_function_ref_DEPENDENCIES_RELEASE absl::base_internal absl::core_headers absl::any_invocable absl::meta)
...
set(abseil_absl_bind_front_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_debugging_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_demangle_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_crc_cpu_detect_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_inlined_vector_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_inlined_vector_internal_DEPENDENCIES_RELEASE absl::compressed_tuple absl::config absl::core_headers absl::memory absl::span absl::type_traits)
...
set(abseil_absl_fixed_array_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cleanup_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_endian_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_malloc_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_variant_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_optional_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_optional_DEPENDENCIES_RELEASE absl::bad_optional_access absl::base_internal absl::config absl::core_headers absl::memory absl::nullability absl::type_traits absl::utility)
...
set(abseil_absl_span_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_span_DEPENDENCIES_RELEASE absl::algorithm absl::core_headers absl::nullability absl::throw_delegate absl::type_traits)
...
set(abseil_absl_bad_any_cast_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_pcg_engine_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_distribution_caller_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_any_invocable_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_stacktrace_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_stacktrace_DEPENDENCIES_RELEASE absl::debugging_internal absl::config absl::core_headers absl::dynamic_annotations absl::raw_logging_internal)
...
set(abseil_absl_hash_policy_traits_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_container_memory_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_compressed_tuple_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cleanup_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_base_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_utility_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_bad_variant_access_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_bad_optional_access_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_bad_any_cast_impl_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_cordz_functions_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_randen_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_wide_multiply_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_generate_real_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_iostream_state_saver_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_numeric_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_memory_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_overload_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_debugging_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_common_policy_traits_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_algorithm_container_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_algorithm_container_DEPENDENCIES_RELEASE absl::algorithm absl::core_headers absl::meta absl::nullability)
...
set(abseil_absl_scoped_set_env_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_throw_delegate_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_spinlock_wait_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_compare_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_uniform_helper_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_randen_hwaes_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_fastmath_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_periodic_sampler_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_int128_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_meta_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_container_common_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_base_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_raw_logging_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_nullability_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_nullability_DEPENDENCIES_RELEASE absl::core_headers absl::type_traits)
...
set(abseil_absl_random_internal_randen_hwaes_impl_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_randen_slow_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_exponential_biased_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_bits_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_type_traits_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_nullguard_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_config_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_flags_commandlineflag_internal_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_leak_check_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_non_temporal_memcpy_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_hashtable_debug_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_prefetch_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_strerror_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_severity_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_atomic_hook_INCLUDE_DIRS_RELEASE )
...
########### COMPONENT absl::if_constexpr VARIABLES ############################################

set(abseil_absl_if_constexpr_INCLUDE_DIRS_RELEASE )
set(abseil_absl_if_constexpr_LIB_DIRS_RELEASE "${abseil_PACKAGE_FOLDER_RELEASE}/lib")
set(abseil_absl_if_constexpr_BIN_DIRS_RELEASE )
set(abseil_absl_if_constexpr_LIBRARY_TYPE_RELEASE STATIC)
set(abseil_absl_if_constexpr_IS_HOST_WINDOWS_RELEASE 0)
set(abseil_absl_if_constexpr_RES_DIRS_RELEASE )
set(abseil_absl_if_constexpr_DEFINITIONS_RELEASE )
set(abseil_absl_if_constexpr_OBJECTS_RELEASE )
set(abseil_absl_if_constexpr_COMPILE_DEFINITIONS_RELEASE )
set(abseil_absl_if_constexpr_COMPILE_OPTIONS_C_RELEASE "")
set(abseil_absl_if_constexpr_COMPILE_OPTIONS_CXX_RELEASE "")
set(abseil_absl_if_constexpr_LIBS_RELEASE )
set(abseil_absl_if_constexpr_SYSTEM_LIBS_RELEASE )
set(abseil_absl_if_constexpr_FRAMEWORK_DIRS_RELEASE )
set(abseil_absl_if_constexpr_FRAMEWORKS_RELEASE )
set(abseil_absl_if_constexpr_DEPENDENCIES_RELEASE absl::config)
set(abseil_absl_if_constexpr_SHARED_LINK_FLAGS_RELEASE )
set(abseil_absl_if_constexpr_EXE_LINK_FLAGS_RELEASE )
set(abseil_absl_if_constexpr_NO_SONAME_MODE_RELEASE FALSE)

# COMPOUND VARIABLES
set(abseil_absl_if_constexpr_LINKER_FLAGS_RELEASE
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${abseil_absl_if_constexpr_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${abseil_absl_if_constexpr_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${abseil_absl_if_constexpr_EXE_LINK_FLAGS_RELEASE}>
)
set(abseil_absl_if_constexpr_COMPILE_OPTIONS_RELEASE
    "$<$<COMPILE_LANGUAGE:CXX>:${abseil_absl_if_constexpr_COMPILE_OPTIONS_CXX_RELEASE}>"
    "$<$<COMPILE_LANGUAGE:C>:${abseil_absl_if_constexpr_COMPILE_OPTIONS_C_RELEASE}>")
########### COMPONENT absl::cordz_update_tracker VARIABLES ############################################

set(abseil_absl_cordz_update_tracker_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_has_ostream_operator_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_platform_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_fast_uniform_bits_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_internal_traits_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_random_seed_gen_exception_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_numeric_representation_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_log_internal_voidify_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_non_temporal_arm_intrinsics_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_node_slot_policy_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_hashtable_debug_hooks_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_algorithm_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_fast_type_id_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_core_headers_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_dynamic_annotations_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_no_destructor_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_no_destructor_DEPENDENCIES_RELEASE absl::config)
...
set(abseil_absl_errno_saver_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_time_zone_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_civil_time_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_pretty_function_INCLUDE_DIRS_RELEASE )
...
set(abseil_absl_config_INCLUDE_DIRS_RELEASE )
