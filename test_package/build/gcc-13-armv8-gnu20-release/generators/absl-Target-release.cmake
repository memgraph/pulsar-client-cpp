...
set_property(TARGET abseil_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:absl::config;absl::core_headers;absl::type_traits;absl::atomic_hook;absl::errno_saver;absl::log_severity;absl::base_internal;absl::base;absl::dynamic_annotations;absl::raw_logging_internal;absl::nullability;absl::spinlock_wait;absl::algorithm;absl::meta;absl::utility;absl::cleanup_internal;absl::container_common;absl::common_policy_traits;absl::compare;absl::compressed_tuple;absl::container_memory;absl::cord;absl::layout;absl::memory;absl::strings;absl::throw_delegate;absl::span;absl::inlined_vector_internal;absl::hash_function_defaults;absl::raw_hash_map;absl::algorithm_container;absl::raw_hash_set;absl::node_slot_policy;absl::hash;absl::exponential_biased;absl::sample_recorder;absl::synchronization;absl::time;absl::hashtable_debug_hooks;absl::bits;absl::endian;absl::hash_policy_traits;absl::hashtablez_sampler;absl::optional;absl::prefetch;absl::debugging_internal;absl::crc_cpu_detect;absl::crc_internal;absl::non_temporal_memcpy;absl::str_format;absl::non_temporal_arm_intrinsics;absl::crc32c;absl::demangle_internal;absl::malloc_internal;absl::stacktrace;absl::symbolize;absl::examine_stack;absl::leak_check;absl::flags_path_util;absl::flags_program_name;absl::int128;absl::fast_type_id;absl::flags_commandlineflag_internal;absl::flags_commandlineflag;absl::flags_private_handle_accessor;absl::flags_config;absl::flat_hash_map;absl::no_destructor;absl::flags_marshalling;absl::flags_internal;absl::flags_reflection;absl::flags;absl::flags_usage_internal;absl::flags_usage;absl::any_invocable;absl::city;absl::fixed_array;absl::function_ref;absl::variant;absl::low_level_hash;absl::log_internal_check_op;absl::log_internal_conditions;absl::log_internal_message;absl::log_internal_strip;absl::log_internal_nullguard;absl::log_internal_nullstream;absl::log_internal_voidify;absl::log_internal_append_truncated;absl::log_internal_config;absl::log_internal_globals;absl::absl_vlog_is_on;absl::inlined_vector;absl::log_internal_format;absl::log_internal_proto;absl::log_internal_log_sink_set;absl::log_globals;absl::log_entry;absl::log_sink;absl::log_sink_registry;absl::strerror;absl::cleanup;absl::log_internal_check_impl;absl::log_internal_log_impl;absl::log;absl::log_internal_flags;absl::vlog_config_internal;absl::vlog_is_on;absl::absl_log;absl::strings_internal;absl::log_internal_structured;absl::log_internal_fnmatch;absl::random_distributions;absl::random_internal_nonsecure_base;absl::random_internal_pcg_engine;absl::random_internal_pool_urbg;absl::random_internal_randen_engine;absl::random_seed_sequences;absl::random_internal_distribution_caller;absl::random_internal_fast_uniform_bits;absl::random_internal_generate_real;absl::random_internal_fastmath;absl::random_internal_iostream_state_saver;absl::random_internal_traits;absl::random_internal_uniform_helper;absl::random_internal_wide_multiply;absl::random_internal_salted_seed_seq;absl::random_internal_seed_material;absl::random_seed_gen_exception;absl::random_internal_randen;absl::random_internal_platform;absl::random_internal_randen_hwaes;absl::random_internal_randen_slow;absl::random_internal_randen_hwaes_impl;absl::has_ostream_operator;absl::status;absl::string_view;absl::charset;absl::str_format_internal;absl::numeric_representation;absl::crc_cord_state;absl::cordz_update_tracker;absl::cord_internal;absl::cordz_functions;absl::cordz_handle;absl::cordz_statistics;absl::cordz_info;absl::cordz_update_scope;absl::graphcycles_internal;absl::kernel_timeout_internal;absl::civil_time;absl::time_zone;absl::bad_any_cast;absl::bad_any_cast_impl;absl::bad_optional_access;absl::bad_variant_access>)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT absl::if_constexpr #############

        set(abseil_absl_if_constexpr_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(abseil_absl_if_constexpr_FRAMEWORKS_FOUND_RELEASE "${abseil_absl_if_constexpr_FRAMEWORKS_RELEASE}" "${abseil_absl_if_constexpr_FRAMEWORK_DIRS_RELEASE}")

        set(abseil_absl_if_constexpr_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET abseil_absl_if_constexpr_DEPS_TARGET)
            add_library(abseil_absl_if_constexpr_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET abseil_absl_if_constexpr_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'abseil_absl_if_constexpr_DEPS_TARGET' to all of them
        conan_package_library_targets("${abseil_absl_if_constexpr_LIBS_RELEASE}"
                              "${abseil_absl_if_constexpr_LIB_DIRS_RELEASE}"
                              "${abseil_absl_if_constexpr_BIN_DIRS_RELEASE}" # package_bindir
                              "${abseil_absl_if_constexpr_LIBRARY_TYPE_RELEASE}"
                              "${abseil_absl_if_constexpr_IS_HOST_WINDOWS_RELEASE}"
                              abseil_absl_if_constexpr_DEPS_TARGET
                              abseil_absl_if_constexpr_LIBRARIES_TARGETS
                              "_RELEASE"
                              "abseil_absl_if_constexpr"
                              "${abseil_absl_if_constexpr_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET absl::if_constexpr
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_LIBRARIES_TARGETS}>
                     )

        if("${abseil_absl_if_constexpr_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET absl::if_constexpr
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET absl::if_constexpr APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET absl::if_constexpr APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET absl::if_constexpr APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_LIB_DIRS_RELEASE}>)
        set_property(TARGET absl::if_constexpr APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET absl::if_constexpr APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${abseil_absl_if_constexpr_COMPILE_OPTIONS_RELEASE}>)
    ...
    set_property(TARGET abseil::abseil APPEND PROPERTY INTERFACE_LINK_LIBRARIES absl::if_constexpr)
